...
- [12 Widget UX Overhaul Ledger](12_WIDGET_UX_OVERHAUL_LEDGER.md) — per-Widget visual audit, functional corrections, responsive height contracts, and the gated two-cycle implementation evidence record.
