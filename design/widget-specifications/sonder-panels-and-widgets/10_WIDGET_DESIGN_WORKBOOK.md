...
|---|---:|---|
| Editable source `sonder-workbench-calibration.html` | 532,888 | `F20C5ECA568775263D35B0F9B10562841A7B8C914EF79CD06A463D44A5FD3025` |
| Package preview `sonder-workbench-calibration-preview.html` | 909 | `14C735C159724E03B66E84CF166B7937F99F0654D9EA9D7D36374D0A9A15E557` |
| Regression harness `sonder-drag-regression.html` | 94,425 | `F011201FD38F77F02BB2E8566CA79CCC92BE2804BF0EDCEF60FAD72590400E90` |

The package preview is a same-origin wrapper over the editable source rather
than a duplicated `srcdoc`. It therefore loads the vendored fonts under its
sandbox without remote runtime resources and always displays the exact
committed source revision.

### Browser evidence and reviewed differences

The fresh canonical run at
`http://127.0.0.1:8765/sonder-drag-regression.html` reported **85/85 passed**
...
horizontal document overflow. It also verifies that cancelled or invalid
Settings, Library, and Scene drags restore the exact source group, layout
position, dimensions, and inline-style state. Native pointer cancellation and
custom floating-window geometry are covered, and the package preview proves
all three vendored fonts load without a remote resource.

Manual browser review covered the full desktop Catalog, the `390×844` phone
Catalog, a placed Story and Frame Context module, an access-denied state,
Settings, Library, and Scene invalid/cancelled drag recovery, a valid Scene
float, and the regenerated preview shell. The canonical workbench composition, region
