...
Use stable target ownership and generous hit regions. Once a Widget-body intent
band owns the target, retain it until the pointer moves 10 px beyond the band
boundary; the title/tab strip and explicit shelf rails still take ownership
immediately.
