...
- Outside the title/tab strip, the top 25% of a docked Widget targets a shelf
  above, the middle 50% targets a tab, and the bottom 25% targets a shelf below.
  The title/tab strip and explicit insertion rails always override these body
  bands.
