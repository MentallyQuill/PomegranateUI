...
export const BUNNY_THEME: ThemeDefinitionV2 = {
  ...
  materials: {
    ...
    panel: material({ base: 'surfaceElevated', opacity: 0.08, blurPx: 10, borderWidthPx: 0, rimOpacity: 0 }),
    ...
    header: material({ base: 'surfaceElevated', fallback: 'surface', opacity: 0.16, blurPx: 0, border: 'surfaceElevated', borderOpacity: 0.42, rimOpacity: 0.46 }),
