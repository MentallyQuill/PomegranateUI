...
export type SurfacePresentation = 'reader' | 'composer' | 'progress' | 'telemetry' | 'versions' | 'inspector' | 'condition' | 'ambience' | 'backdrop' | 'tasks' | 'archive' | 'roster' | 'wizard' | 'document' | 'tree' | 'relationships' | 'generator' | 'credentials' | 'assignments' | 'theme' | 'accessibility' | 'sound-motion' | 'maintenance' | 'prompt' | 'system';
...
export const SURFACE_FIXTURES: ReadonlyMap<WidgetType, SurfaceFixture> = new Map([
  ...
  fixture('settings.theme', 'theme', 'This device · preset library', [['Current', 'Deep Current'], ['Presets', '4 semantic previews'], ['Custom draft', 'Device-local']], 'Selects complete presets only; authoring belongs to Custom Theme and its element Widgets.', ['Open Custom Theme'], DRAFT),
  ...
  fixture('settings.theme-colors', 'system', 'This device · shared Theme draft', [['Semantic roles', 'Canvas · Glass · Chrome · Ambient · Text · Source'], ['Input', 'Picker · Hex · RGB']], 'Every placement edits the same draft; invalid color input leaves the last valid target applied.', [], DRAFT),
  fixture('settings.theme-materials', 'system', 'This device · shared Theme draft', [['Glass Density', '50%'], ['Bar Opacity', '60%'], ['Selected Strength', '12%'], ['Frost Level', '50%']], 'Every placement edits the same four bounded material controls.', [], DRAFT),
  fixture('settings.theme-canvas', 'system', 'This device · shared Theme draft', [['Image Strength', '100%'], ['Overlay Strength', '100%'], ['Gradient Direction', '90°'], ['Vignette Strength', '100%']], 'Availability comes from preset canvas data; edits never inspect a concrete theme id.', [], DRAFT),
  fixture('settings.theme-ambient', 'system', 'This device · shared Theme draft', [['Position', 'X · Y'], ['Radius', '42%'], ['Power', '64%']], 'Every placement edits the same ambient profile in the recoverable draft.', [], DRAFT),
  fixture('settings.accessibility', 'accessibility', 'This device · accessibility owner', [['Contrast', 'Standard · device'], ['Text scale', '100% · device'], ['Reduced motion', 'Uses system'], ['Focus visibility', 'Standard · device'], ['Reading support', 'Off · device']], 'Example accessibility preferences; these controls do not change this device.', ['Reset accessibility settings'], DRAFT),
  ...
  fixture('settings.reading-layout', 'system', 'This theme · bundled typography', [['Interface', 'Bundled family'], ['Reading', 'Semantic scale'], ['Spacing', 'Line height and tracking']], 'Typography choices belong to the active theme and apply live without requesting access to local fonts.', ['Save theme typography'], DRAFT),
  fixture('settings.sound-motion', 'sound-motion', 'This device · sound and motion', [['Interface sounds', 'On'], ['Animation', 'Reduced'], ['Autoplay ambience', 'Ask first']], 'Example sound and motion preferences; these controls do not change sound, animation, or playback.', ['Save sound and motion'], DRAFT),
  ...
  fixture('settings.accessibility-controls', 'accessibility', 'This device · example accessibility controls', [['Contrast', 'Enhanced'], ['Focus indicators', 'Strong'], ['Reduced motion', 'On']], 'Example accessibility preferences; these controls do not change this device.', ['Save accessibility controls'], DRAFT),
