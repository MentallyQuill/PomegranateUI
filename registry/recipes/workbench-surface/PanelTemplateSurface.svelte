<script lang="ts">
  ...
  let { surface, store, renderWidget, titleFor }: { surface: PanelSurfaceProjection; store: WorkbenchStore; renderWidget: Snippet<[WidgetFrameProjection]>; titleFor?: ((frame: WidgetFrameProjection) => string) | undefined } = $props();
</script>
