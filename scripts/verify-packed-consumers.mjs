...
async function writeSvelteConsumer(consumerRoot, tarballs) {
  ...
  await writeFile(path.join(consumerRoot, 'src', 'App.svelte'), [
    ...
    '  {#if panelOrderOpen}',
    '    <section role="dialog" aria-label="Reorder Panels" data-panel-order-surface data-panel-order-request-panel-id={panelOrderRequest?.panelId} data-panel-order-request-invoking-tab-id={panelOrderRequest?.invokingTab.id}>',
    ...
    '  {#if activeSubPanel}',
    '    <section role="tabpanel" id={activeSubPanel.surfaceId} aria-labelledby={activeSubPanel.tabId} data-packed-sub-panel-surface>',
