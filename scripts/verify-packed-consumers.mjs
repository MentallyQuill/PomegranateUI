...
async function writeSvelteConsumer(consumerRoot, tarballs) {
  ...
  await writeFile(path.join(consumerRoot, 'vitest.setup.ts'), [
  ...
  await writeFile(path.join(consumerRoot, 'src', 'App.svelte'), [
    ...
    "  import { THEME_PART_IDS, asPanelId, asWidgetInstanceId, asWidgetType, type PanelId, type WidgetManifest, type WorkbenchState } from '@pomegranate-ui/contracts';",
    "  import { createCatalogController, createWidgetRegistry, createWorkbenchStore, selectPanelTabs } from '@pomegranate-ui/core';",
    "  import { createInitialWorkbenchState, createPanel, createPanelTemplateRegistry, createShelf, createWidget, type LayoutResult } from '@pomegranate-ui/layout';",
    ...
    '  function openPanelOrder() { panelOrderOpen = true; }',
    ...
    '  {#if panelOrderOpen}',
    '    <section role="dialog" aria-label="Reorder Panels" data-panel-order-surface>',
