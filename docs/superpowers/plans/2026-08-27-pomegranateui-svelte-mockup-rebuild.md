...
- [x] **Step 1: Add failing manifest-schema tests for Catalog metadata**
...
- [x] **Step 2: Run the focused contracts test and verify red**
...
- [x] **Step 3: Add the Catalog metadata contract and schema**
...
- [x] **Step 4: Add failing tests for the Catalog controller**
...
- [x] **Step 6: Implement the minimal framework-neutral Catalog controller**
...
- [x] **Step 7: Add failing view-projection/controller tests**
...
- [x] **Step 10: Run focused and boundary verification**
...
- [x] **Step 1: Write failing renderer-driver tests**
...
- [x] **Step 2: Run renderer conformance tests and verify red**
...
- [x] **Step 3: Implement the renderer driver and literal IDs**
...
- [x] **Step 4: Prove non-Svelte portability**
...
- [x] **Step 5: Document the public adoption contract**
...
- [x] **Step 1: Install and pin the Svelte toolchain**
...
- [x] **Step 2: Write failing adapter/context/registry tests**
...
- [x] **Step 3: Run Svelte package tests and verify red**
...
- [x] **Step 4: Implement store adapters and contexts**
...
- [x] **Step 5: Implement renderer registry and focus action**
...
- [x] **Step 6: Verify package boundaries and package output**
...
- [x] **Step 1: Write failing registry/tooling tests**
...
- [x] **Step 3: Implement Panel, surface, frame, Catalog, and error recipes**
...
- [x] **Step 4: Generate and check deterministic metadata**
...
- [x] **Step 5: Verify recipes and commit Task 4**
...
- [x] **Step 1: Copy recipe sources into the Lab and prove source ownership**
...
- [x] **Step 2: Write failing Lab component tests**
...
- [x] **Step 3: Run Lab tests and verify red**
...
- [x] **Step 4: Build deterministic app-owned Catalog fixtures**
...
- [x] **Step 5: Seed the mockup Workbench state through public layout APIs**
...
- [x] **Step 6: Implement the Svelte application shell**
...
- [x] **Step 7: Implement the mockup visual system**
...
- [x] **Step 8: Run component, type, and build verification**
...
- [x] **Step 1: Write failing script/lifecycle tests**
...
- [x] **Step 3: Add durable dev/preview scripts**
...
- [x] **Step 4: Write failing wide/compact/focus/Catalog browser tests**
...
- [x] **Step 5: Write failing interaction/error/keyboard tests**
...
- [x] **Step 6: Run browser tests and correct implementation gaps**
...
- [x] **Step 7: Capture and review narrow native visual baselines**
...
- [x] **Step 8: Verify local and static artifact behavior**
...
- [x] **Step 1: Write failing clean-consumer and boundary tests**
...
- [x] **Step 3: Implement the packed Svelte consumer**
...
- [x] **Step 4: Remap native evidence without changing promoted IDs**
...
- [x] **Step 5: Update active documentation**
...
- [x] **Step 1: Run the pre-retirement parity gate**
...
- [x] **Step 2: Strengthen boundary tests before deletion**
...
- [x] **Step 5: Run focused retirement checks**
...
- [x] **Step 1: Run every named verification command independently**
...
- [x] **Step 2: Inspect build and repository boundaries**
...
- [x] **Step 4: Report the completed result**
