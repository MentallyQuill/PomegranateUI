...
three scenarios passing and no reviewed deviations. The two wide scenarios use
the `bunny-fidelity` profile to compare the expressive surface contract in
addition to the shared functional and structural measurements.
